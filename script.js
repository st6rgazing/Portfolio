  ...
  const projectsData = [
    {
      ...
      description:
        "A comprehensive e-commerce solution with product management, user authentication, shopping cart functionality, and secure payment processing. The platform features a responsive design that works seamlessly across all devices and screen sizes.",
    ...
    },
    {
      ...
      image: "https://placeholder.svg?height=600&width=800",
      description:
        "An interactive dashboard for visualizing and analyzing business metrics and KPIs. The dashboard provides real-time data updates and customizable views to help businesses make informed decisions.",
      technologies: ["JavaScript", "D3.js", "Express", "MongoDB", "Socket.io"],
      features: [
    ...
    },
    {
      ...
      image: "https://placeholder.svg?height=600&width=800",
      description:
        "A full-stack social media application that allows users to connect, share content, and communicate in real-time. The platform includes features for content creation, user interactions, and personalized feeds.",
    ...
    },
    {
      ...
      image: "https://placeholder.svg?height=600&width=800",
      description:
        "A mobile application for ordering food from local restaurants with real-time order tracking and secure payment processing. The app provides a seamless experience from browsing menus to receiving deliveries.",
      technologies: ["React Native", "GraphQL", "Stripe", "Firebase", "Google Maps API"],
      features: [
